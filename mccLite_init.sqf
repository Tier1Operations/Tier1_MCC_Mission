...
MCC_weather_array = [["Clear",[0, 0, 0, 0, 0]], ["Clouds",[0.35, 0.25, 0.25, 0.0, 0.0]], ["Breeze",[0.5, 0.4, 0.4, 0.0, 0.0]], ["Overcast",[0.6, 0.5, 0.5, 0.0, 0.0]],["Rainy",[0.8, 0.8, 0.7, 0.8, 0.7]],["Storm",[1, 1, 1,1,1]], ["Storm - no rain",[1, 1, 1,0,1]]];
MCC_fog_array = [
		["None",[0,0]],
		["1 - low",[0.05,20]], ["1 - medium",[0.05,40]],["1 - dense",[0.05,60]],
		["2 - low",[0.1,20]], ["2 - medium",[0.1,40]],["2 - dense",[0.1,60]],
		["3 - low",[0.15,25]], ["3 - medium",[0.15,45]],["3 - dense",[0.15,70]],
...
//Bon artillery
//MCC_bonCannons = []; // defined higher up to avoid potential error messages
...
MCC_groupGenGroupStatus = [west,east,resistance,civilian]; 	// Check: allways the case??
...
// sync time and weather etc for HC
